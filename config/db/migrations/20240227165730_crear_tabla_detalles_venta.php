...
final class CrearTablaDetallesVenta extends AbstractMigration
{
    
    public function change(): void
    {
        $table = $this->table('detalles_venta', ['id' => false, 'primary_key' => 'id_detalle']);
        $table
            ...
            ->addForeignKey('id_venta', 'ventas', 'id_venta', ['delete' => 'SET_NULL', 'update' => 'NO_ACTION'])
            ->addForeignKey('id_producto', 'productos', 'id_producto', ['delete' => 'SET_NULL', 'update' => 'NO_ACTION'])
