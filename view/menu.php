                                ...
                                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                                    <div class="menu_section">
                                        <ul class="nav side-menu">
                                            <li><a href="' , constant('URL') , 'dashboard"><i class="fa fa-home"></i> Dashboard </a></li>
                                            <li><a><i class="fa fa-users"></i> Usuarios <span class="fa fa-chevron-down"></span></a>
                                                <ul class="nav child_menu">
                                                    <li><a href="' , constant('URL') , 'usuario">Usuarios</a></li>
                                                    <li><a href="' . constant('URL') . 'rol">Roles</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="' , constant('URL') , 'cliente"><i class="fa fa-user"></i> Clientes </a></li>
                                            <li><a href="' , constant('URL') , 'gimnasio"><i class="fa fa-heart"></i> Gimnasio </a></li>
